...
try:
    ...
    logger.warning(f"MongoDB connection failed: {e}. Falling back to in-memory collection mode.")
    print(f"MongoDB connection failed: {e}. Falling back to in-memory collection mode.")
